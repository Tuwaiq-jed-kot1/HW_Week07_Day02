...
interface FlickrAPI {
    ...
    @GET("movie/popular?api_key=${BuildConfig.MovieKey}&language=en-US&page=1")
    suspend fun fetchMovies(): MoviesData

    @GET("search/movie?api_key=${BuildConfig.MovieKey}&language=en-US&page=1&include_adult=false")
